...
cap = cv2.VideoCapture('C:/Users/DELL/PycharmProjects/number_plate/datafiles/video2.mp4')
#extra addition
...
while True:
    ...
    if text:
        ...
        with open('C:/Users/DELL/PycharmProjects/number_plate/numberplates_data.csv', 'r') as f:
